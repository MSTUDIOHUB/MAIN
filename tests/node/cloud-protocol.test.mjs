...
test("cloud tool and explicit API protocol helpers normalize configured behavior", () => {
  ...
  assert.equal(getDefaultLocalToolProtocol("LM Studio"), "auto");
  assert.equal(getDefaultLocalToolProtocol("Ollama"), "auto");
  ...
  assert.equal(normalizeLocalToolProtocol(undefined, "LM Studio"), "auto");
  assert.equal(normalizeLocalToolProtocol(undefined, "Ollama"), "auto");
