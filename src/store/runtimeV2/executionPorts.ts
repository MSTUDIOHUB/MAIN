...
function containsProviderTextEnvelopePrompt(
  language: "zh" | "en",
...
function baseProviderProfile(state: any): ProviderLaneProfileV1 {
...
function recordApprovedPlanContext(input: RuntimeV2ExecutionPortsInput): void {
...
function providerToolDefinitionsForCommand(
  input: RuntimeV2ExecutionPortsInput,
...
function compactTextEnvelopeCatalog(tools: readonly ToolDefinition[]): string {
