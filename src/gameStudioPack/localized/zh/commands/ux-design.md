---
name: ux-design
description: "为菜单、HUD、交互流和关键页面撰写 UX 方案，确保体验路径清晰。"
...
检查 for `design/art/art-bible.md`. If found, read the visual direction
section. UX layout must align with the aesthetic commitments already made.

### 2g: Accessibility Requirements

检查 for `design/accessibility-requirements.md`. If found, read it. The spec
...
> | Section | Status |
> |---------|--------|
> | Overview & Context | [完成 / Empty / Placeholder] |
...
- "完成 this sentence: 'The player arrives at this screen wanting to ___.' "
...
完成 this before any layout work. Do not skip it.
...
> **Cross-Reference 检查: [Screen Name]**
...
结论: **COMPLETE** — UX spec written and approved section by section.
