---
name: team-audio
description: "编排多位专家协同处理音频、音乐与声音实现。"
argument-hint: "[feature 或 area to design audio for]"
user-invocable: true
---
...
- 检查 that no gameplay state is communicated by audio alone (all must have a visual fallback)
...
结论: **COMPLETE** — audio design document produced and team pipeline finished.
