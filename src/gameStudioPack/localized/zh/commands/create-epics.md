---
name: create-epics
description: "把设计与架构拆成可推进的 Epic，建立模块级实施骨架。"
...
检查 ADR coverage against the TR registry:
...
- **结论: COMPLETE** — [N] epic(s) written. Run `/create-stories [epic-slug]` per epic.
- **结论: BLOCKED** — user declined all epics, or no eligible systems found.
