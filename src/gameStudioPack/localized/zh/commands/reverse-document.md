...
## 阶段 5: Draft Document Using Template
...
## 阶段 6: Show Draft and Request Approval
...
## 阶段 7: Write Document with Metadata
...
7. **Get Approval**: "May I write to [filepath]?" On approval: 结论: **COMPLETE** — document generated. On decline: 结论: **BLOCKED** — user declined write.
