...
and story files to find stories with Status: 完成 this sprint.
...
## 6. Generate 报告 and Suite Manifest

### 报告 format (in conversation)
...
结论: **COMPLETE** — regression suite updated. (If user declined write: 结论: **BLOCKED**.)
