...
description: "从已接受的 ADR 生成统一的程序实现规则清单，便于团队按同一标准开发。"
...
### 必需 Patterns (from "Implementation Guidelines" section)
...
- Engine-recommended patterns → 必需 entries
...
3. **Ask before writing** — always confirm before creating or overwriting the manifest. On write: 结论: **COMPLETE** — control manifest written. On decline: 结论: **BLOCKED** — user declined write.
