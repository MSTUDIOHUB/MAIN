...
description: "产出覆盖主要系统的总体架构文档，明确模块边界、职责和依赖。"
...
## 阶段 5: ADR Audit + Traceability 检查
...
Count: X covered, Y gaps. For each gap, it becomes a **必需 New ADR**.
...
## 阶段 7: Write the Master Architecture Document
...
## 阶段 7b: Technical Director Sign-Off + Lead Programmer Feasibility Review
...
Apply gate **TD-ARCHITECTURE** (`.protocols/game-studio/docs/director-gates.md`) as a self-review. 检查 all four criteria from that gate definition against the completed document.
