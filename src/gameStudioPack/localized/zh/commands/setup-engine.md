---
name: setup-engine
description: "配置引擎、版本、语言、运行时路径以及基础技术约束，建立后续开发基线。"
...
检查 whether the engine version is likely beyond the LLM's training data.
...
2. 检查 deprecated APIs before suggesting code
3. 检查 breaking changes for relevant version transitions
...
结论: **COMPLETE** — engine configured and reference docs populated.
