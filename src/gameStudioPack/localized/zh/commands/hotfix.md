---
name: hotfix
description: "为紧急线上问题规划最小修复路径、风险控制和发布节奏。"
argument-hint: "[bug-id 或 description]"
user-invocable: true
...
## 阶段 6: Update Bug Status and Deploy
