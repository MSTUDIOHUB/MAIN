...
- 检查 whether `design/gdd/systems-index.md` exists. If it does, read it to
...
- 检查 `design/quick-specs/` for any prior quick specs that touched this
...
报告 what was found: "Found GDD at [path]. Relevant section: [section name].
...
System: [system name]
GDD update: [必需 — pending approval / Applied / Not required]
...
结论: **COMPLETE** — quick design spec written and ready for implementation.
