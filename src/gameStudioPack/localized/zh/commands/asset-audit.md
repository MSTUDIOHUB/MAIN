...
## 阶段 4: Output Audit 报告

```markdown
# Asset Audit 报告 -- [Category] -- [Date]
...
## 结论: [COMPLIANT / WARNINGS / NON-COMPLIANT]
```

此技能为只读 — it produces a report but does not write files.
