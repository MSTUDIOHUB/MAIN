...
- 检查 for game-concept.md, game-pillars.md, systems-index.md
...
Based on scanned artifacts, determine stage. 检查 `production/stage.txt` first —
...
### 5. Role-Filtered Recommendations (可选)
