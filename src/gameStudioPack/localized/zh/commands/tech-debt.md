...
If yes, update the register (append new entries, do not overwrite existing ones). 结论: **COMPLETE** — scan findings written to register.
...
If yes, append the entry. 结论: **COMPLETE** — entry added to register.

If no, stop here. 结论: **BLOCKED** — user declined write.

---

## 阶段 2C: Prioritize Mode
...
If yes, write the updated file. 结论: **COMPLETE** — register re-prioritized and saved.
...
Output the report to the user. This mode is read-only — no files are written. 结论: **COMPLETE** — debt report generated.
