---
name: bug-triage
description: "对缺陷做优先级、归类、影响判断和处理建议。"
...
- 检查 whether the current sprint has remaining capacity
...
- Bug filed against a story marked 完成 → "Regression in completed story —
...
- If no P1 bugs exist: "No P1 bugs — build is in good shape for QA hand-off." 结论: **COMPLETE** — triage report written.

If user declined write: 结论: **BLOCKED** — user declined write.
