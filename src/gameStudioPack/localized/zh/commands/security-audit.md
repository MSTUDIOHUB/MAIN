---
name: security-audit
description: "审查安全风险、权限边界、数据暴露和潜在滥用点。"
...
## 阶段 1: Parse Arguments and Scope
...
> "✅ No blocking security findings. 报告 written to `production/security/`. Include this path when running `/gate-check release`."
