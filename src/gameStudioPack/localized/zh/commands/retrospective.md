...
## 阶段 1b: 检查 for Existing Retrospective
...
## 阶段 2: Load Sprint or Milestone Data
...
- **[B] Stop** — abort the skill. 结论: **BLOCKED** — no sprint data available.
...
## 阶段 3: Analyze Completion and Trends

Scan for completed and incomplete tasks by comparing the plan against actual deliverables. 检查 for:
...
## 阶段 4: Generate the Retrospective
...
|------|----------------|---------------|--------|--------|
| [Task that was not completed] | [Sprint N-X] | [N] | [Why] | [完成 / Descope / Redesign] |
...
If yes, write the file, creating the directory if needed. 结论: **COMPLETE** — retrospective saved.

If no, stop here. 结论: **BLOCKED** — user declined write.
...
- 检查 whether previous action items were completed. Recurring unaddressed items are a process smell.
