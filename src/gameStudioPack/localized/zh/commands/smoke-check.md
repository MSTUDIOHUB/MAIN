...
报告 findings before proceeding: "Environment: [engine]. Test directory:
...
environments. 检查 for recent test result artifacts:
```bash
...
| Platform | Checks Run | Passed | Failed | Platform 结论 |
|----------|-----------|--------|--------|-----------------|
| PC | [N] | [N] | [N] | PASS / FAIL |
...
[结论 rules — first matching rule wins:]
