...
## 阶段 4: Generate Internal Changelog
...
## 阶段 5: Generate Player-Facing Changelog
...
- 检查 whether `docs/CHANGELOG.md` exists before asking. If it does, default the
...
After a successful write: 结论: **CHANGELOG WRITTEN** — changelog saved to `docs/CHANGELOG.md`.
If the user declines: 结论: **COMPLETE** — changelog generated.
