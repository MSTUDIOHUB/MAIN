...
4. **检查 the risk register** at `production/risk-register/`.

---

## 阶段 2: Generate Output
...
After handling the producer's verdict, ask: "May I write this sprint plan to `production/sprints/sprint-[N].md`?" If yes, write the file, creating the directory if needed. 结论: **COMPLETE** — sprint plan created. If no: 结论: **BLOCKED** — user declined write.
