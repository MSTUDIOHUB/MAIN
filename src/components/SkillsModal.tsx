...
const SKILLS_COPY = {
  zh: {
    ...
    toolDesc: "工具型技能会转换为可调用的工具函数，模型可通过 function calling 主动调用。",
    ...
    toolExecutionInstructions: "工具执行说明",
    edit: "编辑",
    preview: "预览",
    contentPlaceholderInstruction: "输入给模型的规则和说明（支持 Markdown）...",
    contentPlaceholderTool: "描述这个工具被调用时要做什么（支持 Markdown）...",
    nothingToPreview: "暂无可预览内容",
    toolParameters: "工具参数",
    toolParametersDesc: "定义此工具接受的参数格式，符合 OpenAI function calling 规范。",
    cancel: "取消",
    updateSkill: "更新技能",
    saveSkill: "保存技能",
    done: "完成",
  ...
  en: {
    ...
    toolDesc: "Tool skills become callable tool functions that the model can invoke through function calling.",
    ...
    toolExecutionInstructions: "Tool Execution Instructions",
    edit: "Edit",
    preview: "Preview",
    contentPlaceholderInstruction: "Enter the rules and instructions for the model (Markdown supported)...",
    contentPlaceholderTool: "Describe what this tool does when called (Markdown supported)...",
    nothingToPreview: "Nothing to preview",
    toolParameters: "Tool Parameters",
    toolParametersDesc: "Define the parameter schema this tool accepts, using the OpenAI function calling format.",
    cancel: "Cancel",
