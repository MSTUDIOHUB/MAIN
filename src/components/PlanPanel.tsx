...
const COPY = {
  zh: {
    ...
    generatingFooter: "计划仍在补全中。先生成正式 design 方案供确认，确认后再生成执行任务；数据分析类任务会优先形成分析方案，而不是直接改代码。",
  ...
  en: {
    ...
    generatingFooter: "The plan is still being completed. Finish the formal design proposal first; tasks will be generated after approval. Data-analysis plans should stay analysis-first instead of jumping straight to code changes.",
