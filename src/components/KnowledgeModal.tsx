...
const COPY = {
  zh: {
    ...
    create: "新建知识库",
    namePlaceholder: "例如 Unity API 手册",
  ...
  en: {
    ...
    namePlaceholder: "e.g. Unity API Manual",
            ...
            <div className="flex-1 overflow-y-auto p-5">
              <div className="mb-4 flex items-start justify-between gap-4">
                ...
                <div className="flex shrink-0 items-center gap-2">
                  ...
                  <button onClick={importSources} disabled={!!busy} className="flex items-center gap-2 rounded-md theme-bg px-3 py-2 text-xs font-bold theme-bg-hover disabled:opacity-50">
