...
export function buildSystemPrompt(
  ...
  if (turnIntent === "plan") {
    parts.push([
      ...
      "",
      "## PLAN 回合核心规则",
      "PLAN 是一个 Codex App 风格的三阶段回合：阶段 1 只读 grounding，阶段 2 收敛关键事实/取舍/默认值，阶段 3 输出 decision-complete 的可见 `<proposed_plan>` 或 Proposal；MAIN runtime 会物化为 `.MAIN/plans/plan.md` 供审批。",
